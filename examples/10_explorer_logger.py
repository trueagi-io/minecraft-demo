...
class Explorer(TAgent):
    ...
    def __init__(self, mc, visualizer=None, goal=None):
        ...
        self.g_counter = 0
        self.pth_to_saved_data = "dataset/"
    ...
    def _logImgActData(self, filename, action):
        SCALE = 4
        img = self._get_image(self.rob.getCachedObserve('getImageFrame'), SCALE, SCALE)
