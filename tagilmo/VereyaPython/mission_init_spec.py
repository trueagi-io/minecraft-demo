...
class MissionInitSpec:
    ...
    def getClientMissionControlPort(self, ) -> int:
        return self.mission_init.client_agent_connection.client_mission_control_port

    def setClientMissionControlPort(self, port: int) -> None:
    ...
    def setAgentColourMapPort(self, port: int) -> None:
    ...
    def hasMinecraftServerInformation(self) -> bool:
        return bool(self.mission_init.minecraft_server.connection_address or
                    self.mission_init.minecraft_server.connection_port)
